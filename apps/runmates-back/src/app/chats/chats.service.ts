...
const welcomeMsg = 'Hi there! 👋 I´m Mateo, your personal running coach in the RunMates app 🏃‍♂️✨. I’m here to help you reach your running goals! What’s your name? 😊';
...
export class ChatsService {
  ...
  //TODO: Finish replacing assistant api with response api
  async processMessage(message: ChatMessage): Promise<ChatMessage | any> {
  ...
  async startSignupConversation(userId: number): Promise<ChatMessage | any> {
